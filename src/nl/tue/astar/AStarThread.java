...
public interface AStarThread<H extends Head, T extends Tail> {
	...
	public static enum QueueingModel {
		DEPTHFIRST, BREADTHFIRST,DEPTHFIRSTWITHCERTAINTYPRIORITY, BREADTHFIRSTWITHCERTAINTYPRIORITY, RANDOM
	};
	...
	public static enum ASynchronousMoveSorting {
		NONE, LOGMOVEFIRST, MODELMOVEFIRST, TOTAL;
	}

	public static class CPUEfficient<H extends Head, T extends Tail> extends AbstractAStarThread<H, T> {
	...
	public static class MemoryEfficient<H extends Head, T extends Tail> extends AbstractAStarThread<H, T> {
